    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <?php if(isset($_SESSION['message'])) { ?>
                <div class="alert alert-<?= $_SESSION ['message_type'] ?> alert-dismissible fade show" role="alert">
                    <?= $_SESSION['message'] ?>    <!--En esta linea muestra el mensaje pintado-->
        ...
        <div class="col-md-8">
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                        $query = "SELECT * FROM tarea"; //En esta linea hago la consulta de las tareas a la BD(llamada tarea).
                        $result_task = mysqli_query($conn, $query); //Guardo la consulta de todas mis tareas guardadas en la variable llamada $result_task.
                        //Ahora recorro las tareas asi puedo pintarlas en la tabla.
